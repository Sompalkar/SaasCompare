...
exports.seedCloudProviders = seedCloudProviders;
exports.seedCloudServices = seedCloudServices;
exports.seedCloudData = seedCloudData;
const client_1 = require("@prisma/client");
const logger_1 = require("./logger");
const prisma = new client_1.PrismaClient();
async function seedCloudProviders() {
    logger_1.logger.info('Starting cloud providers seeding...');
    const providers = [
        {
    ...
    logger_1.logger.info('Cloud providers seeding completed!');
}
// Main seed function to populate cloud services
async function seedCloudServices() {
    logger_1.logger.info('Starting cloud services seeding...');
    ...
    logger_1.logger.info('Cloud services seeding completed!');
}
// Main seed function
async function seedCloudData() {
    try {
        logger_1.logger.info('Starting cloud data seeding...');
        await seedCloudProviders();
        await seedCloudServices();
        logger_1.logger.info('Cloud data seeding completed successfully!');
    }
    catch (error) {
