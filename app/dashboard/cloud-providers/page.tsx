...
export default function DashboardCloudProvidersPage() {
  ...
  // Maximum number of providers to compare (higher for authenticated users)
    ...
    if (selectedProviders.some((p) => p.id === provider.id)) {
      ...
      if (selectedProviders.length >= maxProviders) {
        toast({
          ...
          description: `You can compare up to ${maxProviders} providers.`,
          variant: "destructive",
        })
        return
      }
                ...
                {selectedProviders.length > 0 ? (
                  <motion.div initial="hidden" animate="visible" variants={containerVariants} className="space-y-3">
                    ...
                    <Button
                      ...
                      onClick={() => router.push("/dashboard/cloud-providers/result")}
                    >
                    ...
                    <Button
                      ...
                      onClick={() => {
                        ...
                        toast({
                          ...
                          description: "Your comparison has been saved for later.",
                        })
                      }}
                    >
                      Save Comparison
