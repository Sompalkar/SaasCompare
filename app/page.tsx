...
import { ArrowRight, Check, ChevronRight, LineChart, Search, Star } from "lucide-react"
  ...
  const pricingPlans = [
    {
      ...
      features: ["Compare up to 3 tools", "Basic filtering", "3 saved comparisons"],
      cta: "Get Started",
      popular: false,
    },
    {
      ...
      features: ["Unlimited comparisons", "Advanced filtering", "PDF export", "Email support"],
          ...
          <div className="container relative z-10">
            ...
            >
              ...
              <motion.p variants={itemVariants} className="text-xl text-muted-foreground mb-8">
                Compare pricing, features, and limitations of 1000+ SaaS tools to make informed decisions and save
                money.
              </motion.p>
              ...
              <motion.div variants={itemVariants} className="mt-8 flex flex-wrap justify-center gap-2">
                {["CRM", "Marketing", "Project Management", "Analytics", "Customer Support"].map((category) => (
            ...
            <div className="text-center max-w-3xl mx-auto mb-16">
              ...
              >
                ...
                <p className="text-xl text-muted-foreground">
                  Our comprehensive comparison engine provides all the tools you need to evaluate and select the best
                  SaaS solutions.
                </p>
              </motion.div>
            </div>
          ...
          <div className="container">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
              {pricingPlans.map((plan, index) => (
                ...
                >
                  <Card
                    className={`relative h-full flex flex-col ${plan.popular ? "border-indigo-500 shadow-lg" : ""}`}
                  >
                    {plan.popular && (
                    ...
                    <div className="p-6">
                      ...
                      <Button
                        ...
                        asChild
                      >
                        <Link href={plan.name === "Free" ? "/auth/register" : "/auth/register?plan=pro"}>
          ...
          <div className="container">
            ...
            >
              ...
              <p className="text-xl opacity-90 mb-8">
                Join thousands of companies making smarter software decisions with SaasCompare.
              </p>
      ...
      <footer className="border-t bg-white dark:bg-gray-950">
        <div className="container py-8 md:py-12">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            <div className="col-span-2 md:col-span-1">
              ...
              <p className="text-sm text-muted-foreground">
                Find the best SaaS tools for your business by comparing pricing, features, and limitations.
              </p>
            </div>
            <div>
          ...
          <div className="mt-8 pt-8 border-t text-center text-sm text-muted-foreground">
            © {new Date().getFullYear()} SaasCompare. All rights reserved.
          </div>
        </div>
      </footer>
    </div>
